...
import com.example.weatherapp.databinding.ActivityFullscreenBinding;
...
public class FullscreenActivity extends AppCompatActivity {
    ...
    private TextView cityName , conditionTV , temperatureTV;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        weatherRV = findViewById(R.id.ReclView);
